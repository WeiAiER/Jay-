...
{
    public partial class ReserveStaff : System.Web.UI.Page
    {
        ...
        private void RptBind(string strWhere)
        {
            ...
            DataTable dt_Sub = bll_Sub.GetList("").Tables[0];//需要转换三层架构，dtx.admins替换为dataset.table[0]
            ...
            string pageUrl = Utils.CombUrlTxt("ReserveStaff.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        {
            Response.Redirect(Utils.CombUrlTxt("ReserveStaff.aspx", "keywords={0}", txtKeywords.Text));//跳转页面，并携带keywords
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Utils.CombUrlTxt("ReserveStaff.aspx", "keywords={0}", this.keywords));
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            Alert.AlertAndRedirect("删除成功！", Utils.CombUrlTxt("ReserveStaff.aspx", "keywords={0}", this.keywords));
        }

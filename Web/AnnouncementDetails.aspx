<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AnnouncementDetails.aspx.cs" Inherits="Class_SQL.Web.AnnouncementDetails" %>
                                        ...
                                        <div class="tab-pane fade in active" id="profile-tab1">
                                            <form class="fieldset">
                                                <div class="form-group row">
                                                    <div class="col-xs-6">
                                                        <label for="exampleInputPhone1" style="font-size:medium">公告内容：</label>
                                                        <div id="Div5" class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_Content" runat="server"  class="form-control" TextMode="MultiLine" sucmsg=" " style="height: 80px" name="example-textarea-input"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="exampleInputName2" style="font-size:medium">发布时间：</label>
                                                ...
                                                <div class="modal-footer">
                                                    <asp:Button ID="btn_Save_1" runat="server" Text="保存" class="btn btn-sm btn-app" type="button" data-dismiss="modal"  style="margin-top:15%" OnClick="btnSave_Click"/>
                                                </div>      
                                            </form>
                                        </div>
                                    </div>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HealthSupervision.aspx.cs" Inherits="Class_SQL.HealthSupervision" %>
                ...
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="HealthSupervisionEdit.aspx?action=Add"><button style="margin:auto" class="btn btn-app btn-block" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                </div>

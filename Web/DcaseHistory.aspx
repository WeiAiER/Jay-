<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DcaseHistory.aspx.cs" Inherits="Class_SQL.Web.DcaseHistory" %>
                ...
                <div id="floatHead" class="toolbar">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="DoctorDetail.aspx?action=Add"><button style="margin:auto" class="btn btn-app btn-block" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("MedicalRecordID")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("UserName")%></td>
                        <td align="center"><%#Eval("DiagnosisTime")%></td>
                        <td align="center"><%#Eval("UserDescription")%></td>
                        <td align="center"><%#Eval("ReDiagnosisDate")%></td>
                        <td align="center"><%#Eval("DoctorName")%></td>
                        <td class="text-center">
                            <div>
                                <a href="DoctorDetail.aspx?action=Edit&id=<%#Eval("MedicalRecordID")%>">&nbsp;详情&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>

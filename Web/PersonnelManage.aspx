<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonnelManage.aspx.cs" Inherits="Class_SQL.Web.PersonnelManage" %>
                ...
                <div id="floatHead" class="toolbar">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <a href="PersonnelManageAdd.aspx?action=Add"><button style="margin:auto" class="btn btn-app btn-block" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                </div>
            ...
            <asp:Repeater ID="rptList" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td align="center"><%#Eval("UserPassword")%></td>
                        <td align="center"><%#Eval("PhoneNumber")%></td>
                        <td align="center"><%#Eval("UserType")%></td>
                        <td align="center"><%#Eval("BirthDate")%></td>
                        <td align="center"><%#Eval("UserAddress")%></td>
                        <td class="text-center">
                            <div>
                                <a href="PersonnelManageEdit.aspx?action=Edit&id=<%#Eval("UserID")%>">&nbsp;修改&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>

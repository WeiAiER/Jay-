...
namespace MxWeiXinPF.Web.UI
{
    public class UpLoad
    {
        ...
        public string fileSaveAs(string pathLetter,HttpPostedFile postedFile, bool isThumbnail, bool isWater)
        {
            try
            {
                ...
                string upLoadPath = GetUpLoadPath(pathLetter); //上传目录相对路径
        ...
        private string GetUpLoadPath(string pathLetter)
        {
            string path = siteConfig.webpath + siteConfig.filepath + "/" + pathLetter; //站点目录+上传目录

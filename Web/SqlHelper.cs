...
namespace Class_SQL.Web
{
    public class SqlHelper
    {
        ...
        public static readonly string connstring = ConfigurationManager.ConnectionStrings["ConnectionString_1"].ConnectionString;
        ...
        {
            return new SqlConnection(ConfigurationManager.ConnectionStrings["ConnectionString_1"].ConnectionString);
        }
        /// <summary>
        /// 打开数据库连接
        /// </summary>

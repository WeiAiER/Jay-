<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DoctorDetail.aspx.cs" Inherits="Class_SQL.Web.DoctorDetail" %>
                                                ...
                                                <div class="form-group row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <div id="Div6" class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_OldName" runat="server" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="exampleInputPhone1" style="font-size:medium">就诊时间：</label>
                                                        <div id="Div5" class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_Visiting" runat="server" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <div id="Div4" class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_DName" runat="server" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="exampleInputPhone1" style="font-size:medium">复诊日期：</label>
                                                        <div id="Div11" class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_AgainTime" runat="server" class="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group row" style="height: 25px;" runat="server">
                                                    <div class="col-xs-6">
                                                        <label for="exampleInputPhone1" style="font-size:medium">病情描述：</label>
                                                        <div id="Div7" class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_Illness" runat="server"  class="form-control" TextMode="MultiLine" sucmsg=" " style="height: 80px" name="example-textarea-input"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="exampleInputPhone1" style="font-size:medium">检查情况：</label>
                                                        <div class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_Examine" runat="server"  class="form-control" TextMode="MultiLine" sucmsg=" " style="height: 80px" name="example-textarea-input"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div> 
                                                <div class="form-group row" style="height: 25px;" runat="server">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <div id="Div8" class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_Pharmacy" runat="server"  class="form-control" TextMode="MultiLine" sucmsg=" " style="height: 80px" name="example-textarea-input"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <div class="col-xs-6">
                                                        <label for="exampleInputPhone1" style="font-size:medium">医生医嘱</label>
                                                        <div class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_Doctor" runat="server"  class="form-control" TextMode="MultiLine" sucmsg=" " style="height: 80px" name="example-textarea-input"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div id="Div10" class="form-group row" style="height: 25px;" runat="server">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <div id="Div9" class="col-xs-12" runat="server">
                                                            <asp:TextBox ID="txt_Result" runat="server"  class="form-control" TextMode="MultiLine" sucmsg=" " style="height: 80px" name="example-textarea-input"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <asp:Button ID="btn_Save" runat="server" Text="保存" class="btn btn-sm btn-app" type="button" data-dismiss="modal"  style="margin-top:15%" OnClick="btnSave_Click"/>
                                                </div>      
                                            </form>
                                        </div>
                                    </div>

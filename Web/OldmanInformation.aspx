<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OldmanInformation.aspx.cs" Inherits="Class_SQL.OldmanInformation" %>
                                    ...
                                    <form class="fieldset" runat="server">
                                        ...
                                        <div class="form-group row" runat="server">
                                            <div class="col-xs-6">
                                                ...
                                                <asp:TextBox ID="txt_OldPassword" runat="server" type="text" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group row" runat="server">
                                            <div class="col-xs-6">
                                                ...
                                                <asp:TextBox ID="txt_Phone" runat="server" type="tel" class="form-control"></asp:TextBox>
                                            </div>
                                        ...
                                        <div class="form-group row" runat="server">
                                            <div class="col-xs-6">
                                                ...
                                                <asp:TextBox ID="txt_Birth" runat="server" type="datetime-local" class="form-control"></asp:TextBox>
                                        ...
                                        <div class="form-group row" runat="server">
                                            <div class="col-xs-6">
                                                ...
                                                <asp:TextBox ID="txt_Address" runat="server" type="tel" class="form-control"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="row narrow-gutter" runat="server">
                                            <div class="col-xs-6">

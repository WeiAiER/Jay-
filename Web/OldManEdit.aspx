<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OldManEdit.aspx.cs" Inherits="Class_SQL.Web.OldManEdit" %>
                                            ...
                                            <form id="Form1" class="fieldset" runat="server">
                                                <div id="Div1" class="form-group row" runat="server">
                                                    <div class="col-xs-6">
                                                        ...
                                                        <asp:TextBox ID="txt_OldName" runat="server" type="text" class="form-control" disabled="disabled"></asp:TextBox>
                                                    </div>
                                                ...
                                                <div id="Div3" class="form-group row" runat="server">
                                                    <div id="Div4" class="col-xs-6" runat="server">
                                                        <label for="exampleInputPhone1">联系方式</label>

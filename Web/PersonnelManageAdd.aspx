<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonnelManageAdd.aspx.cs" Inherits="Class_SQL.Web.PersonnelManageAdd" %>
                                            ...
                                            <form id="Form1" class="fieldset" runat="server">
                                                <div id="Div1" class="form-group row" runat="server">
                                                    ...
                                                    <div id="Div2" class="col-xs-6" runat="server">
                                                        ...
                                                        <asp:TextBox ID="txt_Password" runat="server" type="text" class="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div id="Div3" class="form-group row" runat="server">
                                                    <div id="Div4" class="col-xs-6" runat="server">
                                                        ...
                                                        <asp:TextBox ID="txt_PhoneNumber" runat="server" type="text" class="form-control"></asp:TextBox>
                                                    </div>
                                                    <div id="Div5" class="col-xs-6" runat="server">
                                                        <label for="exampleInputPhone2">用户类型</label>
                                                        <asp:TextBox ID="txt_Type" runat="server" type="text" class="form-control"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div id="Div6" class="form-group row" runat="server">
                                                    <div id="Div7" class="col-xs-6" runat="server">
                                                        <label for="exampleInputPhone1">出生日期</label>
                                                        <asp:TextBox ID="txt_Birth" runat="server" type="text" class="form-control"></asp:TextBox>
                                                    </div>
                                                    <div id="Div8" class="col-xs-6" runat="server">
                                                        <label for="exampleInputPhone2">家庭住址</label>
                                                        <asp:TextBox ID="txt_Address" runat="server" type="text" class="form-control"></asp:TextBox>
                                                    </div>
                                                </div>

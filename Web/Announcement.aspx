<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Announcement.aspx.cs" Inherits="Class_SQL.Web.Announcement" %>
        ...
        <div class="app-layout-container">
            ...
            <div class="toolbar-wrap">
                <div id="floatHead" class="toolbar" runat="server">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px;" runat="server">
                                    <a href="AnnouncementDetails.aspx?action=Add"><button style="margin:auto" class="btn btn-app btn-block" data-toggle="modal" data-target="#modal-top" type="button">新增</button></a>
                                </div> 
                ...
                <ItemTemplate>
                    <tr>
                        <td align="center">
                            ...
                            <asp:HiddenField ID="hidId" Value='<%#Eval("TextNumber")%>' runat="server" />
                        </td>
                        <td align="center"><%#Eval("TextInfo")%></td>
                        <td align="center"><%#Eval("TextTime")%></td>
                        <td class="text-center">
                            <div>
                                <a href="AnnouncementDetails.aspx?action=Edit&id=<%#Eval("TextNumber")%>">&nbsp;详情&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>
   ...
   <%--  <script src="assets/js/plugins/datatables/jquery.dataTables.min.js"></script>--%>
    ...
    <script>
        $('.table-sort').dataTable({
            ...
            "aoColumnDefs": [
              { "orderable": false, "aTargets": [0, 20] }// 制定列不参与排序
            ]
        });
    </script>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReservePension.aspx.cs" Inherits="Class_SQL.Web.ReservePension" %>
                ...
                <div id="floatHead" class="toolbar">
                    <div class="l-list">
                        <div style="width:100px;float:left;margin-right:20px">
                                    <asp:LinkButton ID="btnDoctor" runat="server" class="btn btn-app btn-block" OnClientClick="return ExePostBack('btnDoctor');" 
                                    OnClick="btnDoctor_Click"><i></i><span>预约</span></asp:LinkButton>
                                </div> 
                        <div style="width:100px;float:left">
                                    <asp:LinkButton ID="btnDelete" runat="server" class="btn btn-app btn-block" OnClientClick="return ExePostBack('btnDelete');" 
                                    OnClick="btnDelete_Click"><i></i><span>取消预约</span></asp:LinkButton>
                                </div>  
                </div>

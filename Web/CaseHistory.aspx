<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CaseHistory.aspx.cs" Inherits="Class_SQL.CaseHistory" %>
<!DOCTYPE html>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td class="text-center">
                            <div>
                                <a href="OldDetail.aspx?action=Edit&id=<%#Eval("MedicalRecordID")%>">&nbsp;详情&nbsp;</a>
                            </div> 
                        </td>
                    </tr>
                </ItemTemplate>

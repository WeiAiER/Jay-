<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Doctor.aspx.cs" Inherits="Class_SQL.Web.Doctor" %>
                                            ...
                                            <form id="Form1" class="fieldset" runat="server">
                                                <div id="Div1" class="form-group row" runat="server">
                                                    <div id="Div2" class="col-xs-6" runat="server">
                                                        <label for="exampleInputName1" style="font-size: large">姓名</label>
                                                        <asp:Label ID="lab_Name" runat="server" Text="Label" for="exampleInputName2" style="font-size: large"></asp:Label>
                                                    </div>
                                                    <div id="Div3" class="col-xs-6" runat="server">
                                                        <label for="exampleInputName2" style="font-size: large">密码</label>
                                                        <asp:Label ID="lab_Password" runat="server" Text="Label" for="exampleInputName2" style="font-size: large"></asp:Label>
                                                    </div>
                                                </div>
                                                <div id="Div4" class="form-group row" runat="server">
                                                    <div id="Div5" class="col-xs-6" runat="server">
                                                        <label for="exampleInputPhone1" style="font-size: large">联系方式</label>
                                                        <asp:Label ID="lab_PhoneNumber" runat="server" Text="Label" for="exampleInputName2" style="font-size: large"></asp:Label>
                                                    </div>
                                                    <div id="Div6" class="col-xs-6" runat="server">
                                                        <label for="exampleInputPhone2" style="font-size: large">出生日期</label>
                                                        <asp:Label ID="lab_Birth" runat="server" Text="Label" for="exampleInputName2" style="font-size: large"></asp:Label>
                                                    </div>
                                                </div> 
                                                <div id="Div7" class="form-group row" runat="server">
                                                    <div id="Div8" class="col-xs-6" runat="server">
                                                        <label for="exampleInputPhone1" style="font-size: large">家庭住址</label>
                                                        <asp:Label ID="lab_Address" runat="server" Text="Label" for="exampleInputName2" style="font-size: large"></asp:Label>
                                                    </div>
                                                </div> 
                                                <div id="Div9" class="form-group row" runat="server">
                                                    <div id="Div10" class="col-xs-6" runat="server"> 
                                                        <asp:Button ID="btn_Update" runat="server" Text="修改个人信息" class="btn btn-app" type="submit" OnClick="btnUpdate_Click"></asp:Button>
                                                    </div>
                                                </div>  
                                            </form>
                                        </div>
